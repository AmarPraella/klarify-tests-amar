describe("DE FAD test cases", () => {
  beforeEach(() => {
      cy.visit("https://allergiecheck.de/?_ab=0&_fd=0&_sc=1&preview_theme_id=130765291577");
  });
  ...
  const searchLocation = (location) => {
      cy.get("#fad-search").within(() => {
          cy.get(".mapboxgl-ctrl-geocoder--ctrl").clear().type(location);
          cy.wait(200);
  ...
  it("Tests FAD on desktop", () => {
      ...
      cy.get('button[aria-label="Alle akzeptieren"]').click();
