describe("SK FAD test cases", () => {
  beforeEach(() => {
      cy.visit("https://sk.klarify.me/?_ab=0&_fd=0&_sc=1&preview_theme_id=153947799895");
  });
  ...
  it("Tests FAD on desktop", () => {
      ...
      cy.get('button[aria-label="Povoliť všetko"]').click();
